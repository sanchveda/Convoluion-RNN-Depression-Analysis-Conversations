...
save_result_dir = "/run/user/1435515045/gvfs/smb-share:server=istanbul.psychology.pitt.edu,share=raw_data/TPOT/Video_Data/Sanchayan2/result_test/crnn_fold2/"
# training parameters
...
train_data=np.load('./kfold_data/train_data_reliable_2.npy',allow_pickle=True).item()
valid_data=np.load('./kfold_data/test_data_reliable_2.npy',allow_pickle=True).item()
